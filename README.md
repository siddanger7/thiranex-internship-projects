...
Repository of projects completed during the **Thiranex** internship program.
...
Each project is self-contained inside its own folder and includes source code, datasets, generated outputs, and a written report.
...
```text
© siddanger7 | Submitted as part of the Thiranex internship program
```